...
enum POOL_TYPE {
    ...
    POOL_VIABTC= 120,   //http://6Yviabtc.com/
    POOL_BITCOIN_INDIA= 121,   //http://bitcoin-india.org/
    POOL_BITCOIN_COM = 122,   //http://www.bitcoin.com/
    ...
    POOL_BTC_COM = 131,   //https://pool.btc.com/
