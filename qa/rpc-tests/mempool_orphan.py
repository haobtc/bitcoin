...
class MempoolCoinbaseTest(BitcoinTestFramework):
    ...
    def setup_network(self):
        args0 = ["-checkmempool", "-debug=dblayer", "-dbname=xxx", "-dbport=5432", "-dbuser=postgres", "-dbpass=xxxxxxxx", "-dbhost=127.0.0.1","-savetodb=1"]
        args1 = ["-checkmempool", "-debug=dblayer", "-dbname=xxx", "-dbport=5432", "-dbuser=postgres", "-dbpass=xxxxxxxx", "-dbhost=127.0.0.1","-savetodb=0"]
        self.nodes = []
